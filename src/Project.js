      ...
      <div className="project-page">
        <div className="project-container" style={{backgroundImage: 'url("https://www.dqsconsulting.com/wp-content/uploads/2021/10/que-es-el-big-data.jpg")'}}>
          ...
          <div className="sidebar">
            <p>
              There are only 3 of my many projects. I completed these during my school years. During this process, I improved my research skills and learned a lot about software development and teamwork.
            </p>
          </div>
